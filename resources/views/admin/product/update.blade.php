...
<div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    @endif
                    <h4 class="card-title">Product Update Form 
                      <p style="float: right;" class="card-description"><code><a href="{{route('admin.product.index')}}" class="btn btn-info">All Product</a></code>
                    </p>
                    </h4>
                    <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('admin.product.update',$product->id)}}">
                      @csrf
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Title</label>
                        <div class="col-sm-9">
                          <input style="color: red;" type="text" class="form-control" name="title" id="exampleInputMobile" value="{{$product->title}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Price</label>
                        <div class="col-sm-9">
                          <input style="color: red;" type="text" class="form-control" name="price" id="exampleInputMobile" value="{{$product->price}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Quantity</label>
                        <div class="col-sm-9">
                          <input style="color: red;" type="text" class="form-control" name="quantity" id="exampleInputMobile" value="{{$product->quantity}}">
                        </div>
                      </div>
                      <div class="form-group row">
                     ...
                     <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea style="color: red;"  name="description"  cols="81" rows="5" id="exampleTextarea1">{{$product->description}}</textarea>
                        </div>
                      </div>
